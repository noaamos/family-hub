...
import { Geist, Bebas_Neue, Dancing_Script, Heebo, Amatic_SC } from 'next/font/google'
import './globals.css'
...
const amatic = Amatic_SC({ subsets: ['latin', 'hebrew'], weight: ['400', '700'], variable: '--font-amatic' })
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="he" className={`${geist.variable} ${bebas.variable} ${dancing.variable} ${heebo.variable} ${amatic.variable} h-full`}>
